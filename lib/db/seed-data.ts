...
export const seedCommunities: SeedCommunity[] = [
  ...
  {
    community: {
      slug: "the-glenn-buffalo",
      displayName: "The Glenn Buffalo",
      shortName: "The Glenn",
      ...
      logos: oneLogoLight("the-glenn-buffalo"),
      socials: {},
    },
    senders: [],
  },
  ...
  // ---------------- Cottagewood brand ----------------
  {
    community: {
      ...
      hubspot: {},
      brand: DEFAULT_BRAND,
      logos: twoLogos("cottagewood-mankato"),
      socials: {},
    },
    senders: [],
  },
  {
    community: {
      ...
      hubspot: {},
      brand: DEFAULT_BRAND,
      logos: twoLogos("cottagewood-rochester"),
      socials: {},
    },
    senders: [],
  },
...
const CONTACT_BY_SLUG: Record<string, { address?: Address; websiteUrl?: string }> = {
  ...
  "the-glenn-buffalo": { address: { street: "201 1st St NE", city: "Buffalo", state: "MN", zip: "55313" }, websiteUrl: "glennseniorliving.com/buffalo-mn" },
